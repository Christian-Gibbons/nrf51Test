#### Toolchain commands
####
#GCC_INSTALL_ROOT	:= /home/prithvi/DevelopmentTools/gcc-arm-none-eabi-4_8-2014q3
GCC_INSTALL_ROOT	:= /opt/gcc-arm-none-eabi-4_8-2014q3
GCC_VERSION			:= 4.8.4
...
.PHONY: release #rm.jlink upload.jlink
